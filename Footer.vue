      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-1 md:col-span-2">
          ...
          <p class="text-gray-300 mb-4">
            ...
            Discover quality items from top brands with fast shipping and excellent customer service.
          </p>
          <div class="flex space-x-4">
            ...
            <!-- Pinterest -->
            <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors" aria-label="Follow us on Pinterest">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Dribbble -->
            <a href="https://dribbble.com" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors" aria-label="Follow us on Dribbble">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.253 14.894 3.762 13.743 3.762 12.446s.49-2.448 1.364-3.323c.875-.875 2.026-1.365 3.323-1.365s2.448.49 3.323 1.365c.875.875 1.365 2.026 1.365 3.323s-.49 2.448-1.365 3.323c-.875.807-2.026 1.297-3.323 1.297zm7.718 0c-.99 0-1.864-.356-2.539-1.031-.675-.675-1.031-1.549-1.031-2.539s.356-1.864 1.031-2.539c.675-.675 1.549-1.031 2.539-1.031s1.864.356 2.539 1.031c.675.675 1.031 1.549 1.031 2.539s-.356 1.864-1.031 2.539c-.675.675-1.549 1.031-2.539 1.031z"/>
              </svg>
            </a>
            <!-- Facebook -->
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition-colors" aria-label="Follow us on Facebook">
              <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Return and Refund Policy</a></li>
          </ul>
        </div>
